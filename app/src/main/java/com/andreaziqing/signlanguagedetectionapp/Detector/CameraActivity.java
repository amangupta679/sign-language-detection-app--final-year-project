...
public abstract class CameraActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener,
    ...
    private static final String CAMERA_ACTIVITY = "Camera Activity";
    ...
    public void onPreviewFrame(final byte[] bytes, final Camera camera) {
        if (isProcessingFrame) {
            Log.i(CAMERA_ACTIVITY, "Dropping frame!");
            return;
        }
        ...
        try {
            ...
            Log.e(CAMERA_ACTIVITY, "Exception!");
            return;
        }
    ...
    public synchronized void onStart() {
        Log.d(CAMERA_ACTIVITY, "onStart " + this);
        super.onStart();
    }

    @Override
    public synchronized void onResume() {
        Log.d(CAMERA_ACTIVITY, "onResume " + this);
        super.onResume();
    ...
    public synchronized void onPause() {
        Log.d(CAMERA_ACTIVITY, "onPause " + this);
    ...
    public synchronized void onStop() {
        Log.d(CAMERA_ACTIVITY, "onStop " + this);
        super.onStop();
    }

    @Override
    public synchronized void onDestroy() {
        Log.d(CAMERA_ACTIVITY, "onDestroy " + this);
        super.onDestroy();
    }
    ...
    private String chooseCamera() {
        ...
        try {
            for (final String cameraId : manager.getCameraIdList()) {
                ...
                // Pero en esta aplicación sí se utiliza.
                ...
                Log.i(CAMERA_ACTIVITY, "Camera API lv2?: " + useCamera2API);
                return cameraId;
            }
        } catch (CameraAccessException e) {
            Log.e(CAMERA_ACTIVITY, "Not allowed to access camera");
        }
    ...
    protected void fillBytes(final Plane[] planes, final byte[][] yuvBytes) {
        ...
        for (int i = 0; i < planes.length; ++i) {
            ...
            if (yuvBytes[i] == null) {
                Log.d(CAMERA_ACTIVITY, "Initializing buffer " + i + " at size " + buffer.capacity() + ".");
